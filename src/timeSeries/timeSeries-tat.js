 ...
 * @memberOf timeSeries
 * @class Tat
 * @classdesc Tat 応答時間(Turnaround time)の時系列データ
 */
export default function Tat() {
    
    this.cTpsUnit = Tat.prototype.UNIT_CTPS[0];
...
Tat.prototype.createSeries = function (eTat) {
    ...
    cTpsUnits = Tat.prototype.UNIT_CTPS, // #48
    ...
    return {seriesSet: seriesSet, cTpsUnit: this.cTpsUnit};
